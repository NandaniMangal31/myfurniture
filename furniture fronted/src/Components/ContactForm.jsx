...
function ContactForm() {
  ...
  let [formData2, setFromData2] = useState({ lastName: "Nandani" })
  let [formData3, setFromData3] = useState({ email: "Nandanimangal@gmail.com" })
  let [formData4, setFromData4] = useState({ message: "hello guys" })
